...
Cross-cutting test harness notes. Foundry tests live in `contracts/test/`. Worker tests live next to `backend/`. Frontend tests live next to `frontend/`.

This directory is for:

- future e2e / demo rehearsal scripts
