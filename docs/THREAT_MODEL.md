...
**Mitigation:** All writes on-chain; demo instructs auditors to read Blockscout. SEC-011.
...
**Mitigation:** Discovery fail-open is **stated**; verification is on-chain. Auditors use public explorers. Worker checks `eth_chainId` / CC3 chain id. SEC-012.
...
## Residual risk (accepted for MVP / testnet)
